...
We also created an interactive map using Folium to visualize the distribution of events across the entire country. This map has markers for the top 10 cities 
